...
It can span multiple lines."""),
	# Author(s)
	addon_author='Nicolas DUBUS <nicolas.dubus@orange.fr>, Abdelkrim BENSAÏD',
	# URL for the add-on documentation support
	addon_url='https://github.com/ndubus/agenda',
...
import os
pythonSources: list[str] = [os.path.join('addon', 'appModules', '*.py')]
