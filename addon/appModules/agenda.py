...
class AppModule(appModuleHandler.AppModule):
	...
	def event_gainFocus(self, obj, nextHandler):
		...
		if controlID in [9, 10, 11, 12, 13, 14, 15]:
			if controlID==9:		
				if obj.simplePrevious and obj.simplePrevious.simplePrevious and obj.simplePrevious.simplePrevious.name=="SUIVANT":
					fieldHeader[9] = u"Jour de début"
					self.notSearch = 1
				elif obj.simpleNext and obj.simpleNext.simpleNext and obj.simpleNext.simpleNext.windowControlID==11 and (not  obj.simpleNext.simpleNext.simpleNext or obj.simpleNext.simpleNext.simpleNext.simpleNext and not obj.simpleNext.simpleNext.simpleNext.simpleNext.simpleNext):
